      ...
      <Container className="d-flex flex-wrap justify-content-center gap-4 pb-5">
        <div className={styles.card1}>
          ...
          <p className={styles.cardDescription}>
            Bem-vindo ao nosso curso de programação, onde exploraremos as
            fascinantes possibilidades do mundo da codificação. Seja você um
            iniciante buscando entender os conceitos fundamentais ou um
            programador experiente procurando aprimorar suas habilidades, nosso
            curso oferece uma jornada educacional abrangente.
          </p>
        </div>
