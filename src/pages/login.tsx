  ...
  return (
    <>
      ...
      <main className={styles.main}>
        ...
        />
        <Container className="py-5" style={{height: 780}}>
          <p className={styles.formTitle}>Bem-vindo(a) ao CursosFlix!</p>
          <Form className={styles.form} onSubmit={handleLogin}>
            <p className="text-center">
              <strong>Bem-vindo(a) ao CursosFlix!</strong>
            </p>
            <FormGroup>
